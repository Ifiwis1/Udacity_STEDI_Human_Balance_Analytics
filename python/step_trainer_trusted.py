...
CustomerCurated_node1776720739730 = glueContext.create_dynamic_frame.from_catalog(database="stedi", table_name="customer_curated", transformation_ctx="CustomerCurated_node1776720739730")
...
'''
Join_node1776723561103 = sparkSqlQuery(glueContext, query = SqlQuery232, mapping = {"st":StepTrainerLanding_node1776720744665, "cc":CustomerCurated_node1776720739730}, transformation_ctx = "Join_node1776723561103")
