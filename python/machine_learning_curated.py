...
'''
Join_node1776723561103 = sparkSqlQuery(glueContext, query = SqlQuery229, mapping = {"t":StepTrainerTrusted_node1776720744665, "a":AccelerometerTrusted_node1776720739730}, transformation_ctx = "Join_node1776723561103")
...
FROM myDataSource;
'''
SQLQuery_node1776731223579 = sparkSqlQuery(glueContext, query = SqlQuery228, mapping = {"myDataSource":Join_node1776723561103}, transformation_ctx = "SQLQuery_node1776731223579")
